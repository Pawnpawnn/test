...
local function startStableFishing()
    ...
    Rayfield:Notify({
        Title = "🚀 STABLE FISHING Started",
        Content = "FIXED 0.4s | 100% SUCCESS RATE",
        Duration = 4,
        Image = 4483362458
    })
    
    print("🚀 STABLE FISHING ACTIVATED!")
    print("🎯 FIXED SPEED: 0.4s")
...
MainTab:CreateToggle({
    Name = "🚀 STABLE FISHING (0.4s Fixed)",
    CurrentValue = false,
