...
local function StartFishingV5()
    ...
    ResetV5Stats() -- Reset stats setiap start baru
...
-- Enhanced Exclaim Detection dengan Stats Tracking
task.spawn(function()
        ...
        exclaimEvent.OnClientEvent:Connect(function(data)
            if autoFishingV5Enabled and data and data.TextData
                ...
                if head and data.Container == head then
                    ...
                    -- Update stats
                    UpdateV5Stats(1, 0) -- +1 fish caught
...
-- Auto Fishing V5 Loop dengan Stats Tracking
